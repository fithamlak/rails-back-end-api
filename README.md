...
**Hello react with rails** is build using react on rails to display random greeting.   
...
```
git clone https://github.com/fithamlak/hello-rails-back-end.git
```
...
### React App
- [React app](https://github.com/fithamlak/hello-react-front-end)
